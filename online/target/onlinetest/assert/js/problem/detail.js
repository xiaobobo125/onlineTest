    ...
    init: function (contest, questions) {
        ...
        if (contestDetailPage.data.questions[0].questionType == 0) {
            ...
            var selectOptionStr = '<div class="grouped fields">\n' +
                ...
                '                        <h4 class="ui dividing header">正确答案:<span th:text="${'+contestDetailPage.data.questions[0].answer+'}">A</span></h4>\n' +
                '                        <h4 class="ui dividing header" th:if="${'+contestDetailPage.data.questions[0].parse+' != null}">答案解析:</h4>\n' +
                '                        <p style="font-size: 16px;font-weight: bold;" th:if="${'+contestDetailPage.data.questions[0].parse+' != null}" th:text="${data[\'question\'].parse}">\n' +
                '                        </p>\n' +
                '                    </div>\n' +
                '                </div>\n' +
                '</div>';
    ...
    targetQuestionAction: function (index) {
        ...
        if (contestDetailPage.data.questions[index].questionType == 0) {
            ...
            var selectOptionStr = '<div class="grouped fields">\n' +
                ...
                '                    <div class="title"><i class="dropdown icon"></i>查看正确答案</div>\n' +
                '                    <div class="content ui segment">\n' +
                '                        <h4 class="ui dividing header">正确答案:<span th:text="${'+contestDetailPage.data.questions[index].answer+'}">A</span></h4>\n' +
                '                        <h4 class="ui dividing header" th:if="${'+contestDetailPage.data.questions[index].parse+' != null}">答案解析:</h4>\n' +
                '                        <p style="font-size: 16px;font-weight: bold;" th:if="${'+contestDetailPage.data.questions[index].parse+' != null}" th:text="${data[\'question\'].parse}">\n' +
                '                        </p>\n' +
                '                    </div>\n' +
                '                </div>\n' +
                '</div>';
